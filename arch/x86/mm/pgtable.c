...
{
	return __pte_alloc_one(mm, __userpte_alloc_gfp, pmd);
}
...
{
	mitosis_free_tlb_page(tlb, virt_to_page(pud), MITOSIS_CACHE_PUD);
...
{
	mitosis_free_tlb_page(tlb, virt_to_page(p4d), MITOSIS_CACHE_P4D);
