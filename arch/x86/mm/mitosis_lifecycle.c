                        ...
                        if (READ_ONCE(child_page->pt_replica)) {
                            ...
                            if (local_child && page_to_nid(local_child) == node) {
                                ...
                                if (node == primary_node &&
                                    ...
                                    struct page *orig_page = child_page;
                                    struct page *local_page = local_child;
                                    if (orig_page->pmd_huge_pte &&
                                        !local_page->pmd_huge_pte) {
                                        local_page->pmd_huge_pte = orig_page->pmd_huge_pte;
                                        orig_page->pmd_huge_pte = NULL;
                                    }
                                }
